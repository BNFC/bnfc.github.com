...
cf2alex2 :: String -> String -> String -> Bool -> CF -> String
cf2alex2 name errMod shareMod shareStrings cf = 
  unlines $ concat $ intersperse [""] [
    prelude name errMod shareMod shareStrings,
    cMacros,
    rMacros cf,
    restOfAlex shareMod shareStrings cf
   ]

prelude :: String -> String -> String -> Bool -> [String]
prelude name errMod shareMod shareStrings = [
  "-- -*- haskell -*-",
