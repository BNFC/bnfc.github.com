...
cf2Abstract :: String -> CF -> String -> String
cf2Abstract name cf composOpMod = unlines $ [ 
...
prTreeType :: CF -> [String]
prTreeType cf = ["data Tree :: * -> * where"] ++ map (("    "++) . prTreeCons) (cf2cons cf)
 where 
 prTreeCons c
      | isPositionCat cf cat = fun +++ ":: ((Int,Int),String) -> Tree" +++ mkRealType cat
